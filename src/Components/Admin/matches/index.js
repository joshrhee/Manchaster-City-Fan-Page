    ...
    useEffect( () => {
        if (!matches) {
            ...
            .then(snapshot => {
                ...
                showToastError("AdminMatches useEffect error: ", error);
            }).finally(()=> {
    ...
    const loadMoreMatches = () => {
        if (lastVisible) {
            ...
            .then(snapshot => {
                ...
                showToastError("AdminMatches loadMoreMatches error: ", error);
            }).finally(() => {
                setLoading(false);
            })
        } else {
            showToastError("AdminMatches: Nothing to load");
        }
    }
